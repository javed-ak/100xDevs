        ...
        <div className="h-full flex flex-col justify-center">
            <div class="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                ...
                <div class="space-y-4">
                    ...
                    <Link to="/dashboard" className="mt-4 flex justify-center items-center rounded-md text-sm font-medium h-10 px-4 py-2 w-full bg-blue-500 text-white">Go to Dashboard</Link>
                </div>
                </div>
        </div>
      </div>
